...
const MIXED = [
  {
    ...
    items: [
      ...
      { t: "Grover's algorithm", u: "https://en.wikipedia.org/wiki/Grover%27s_algorithm", k: "website", d: "intermediate", s: "The quadratic speedup, and why quadratic is a much smaller deal than the press implies." },
  ...
  },
  {
    ...
    items: [
      ...
      { t: "Stoicism — Internet Encyclopedia of Philosophy", u: "https://iep.utm.edu/stoicism/", k: "website", d: "beginner", s: "A peer-reviewed overview of the whole school, not just the ethics people quote." },
      ...
      { t: "Discourses — Epictetus", u: "https://classics.mit.edu/Epictetus/discourses.html", k: "course", d: "beginner", s: "The lectures the Enchiridion summarises, with the arguments left in." },
      { t: "Stoicism — Stanford Encyclopedia of Philosophy", u: "https://plato.stanford.edu/entries/stoicism/", k: "website", d: "beginner", s: "The scholarly reference. Denser than the IEP and the one to trust on disputes." },
      ...
      { t: "Ancient Ethical Theory", u: "https://plato.stanford.edu/entries/ethics-ancient/", k: "website", d: "intermediate", s: "Where Stoicism sits against Aristotle and the Epicureans, which is how to actually judge it." },
      { t: "Stoic Ethics — IEP", u: "https://iep.utm.edu/stoiceth/", k: "website", d: "intermediate", s: "Virtue, indifferents and the passions, worked through properly." },
      { t: "Stoic Philosophy of Mind — IEP", u: "https://iep.utm.edu/stoicmind/", k: "website", d: "intermediate", s: "Impressions and assent — the psychology the ethics is built on, and usually skipped." },
      { t: "Stoic Logic", u: "https://plato.stanford.edu/entries/logic-ancient/", k: "website", d: "intermediate", s: "The Stoics invented propositional logic. This is the half of the school nobody markets." },
      { t: "Epictetus — SEP", u: "https://plato.stanford.edu/entries/epictetus/", k: "website", d: "intermediate", s: "The former slave who taught the emperor's teachers, and what he actually argued." },
      { t: "Seneca — SEP", u: "https://plato.stanford.edu/entries/seneca/", k: "website", d: "intermediate", s: "Including the uncomfortable part: he wrote this while serving Nero." },
      { t: "Marcus Aurelius — SEP", u: "https://plato.stanford.edu/entries/marcus-aurelius/", k: "website", d: "intermediate", s: "The Meditations read as philosophy rather than as an inspirational quote source." },
      { t: "Ancient Theories of Soul — SEP", u: "https://plato.stanford.edu/entries/ancient-soul/", k: "website", d: "advanced", s: "The physics the ethics depends on. Drop it and 'live according to nature' means nothing." },
      ...
      { t: "Determinism and freedom in Stoic philosophy", u: "https://plato.stanford.edu/entries/freewill/", k: "website", d: "advanced", s: "Compatibilism starts here. The Stoics got to it two thousand years before the moderns." },
      { t: "Causal Determinism — SEP", u: "https://plato.stanford.edu/entries/determinism-causal/", k: "website", d: "advanced", s: "Stoic determinism stated carefully, including how they tried to keep responsibility inside it." },
      ...
      { t: "Cicero — SEP", u: "https://plato.stanford.edu/entries/cicero/", k: "website", d: "advanced", s: "Our single most important source for lost Stoic texts, and an opponent worth reading." },
    ],
  },
  {
    slug: "epistemology",
    ...
    items: [
      { t: "Epistemology — Stanford Encyclopedia of Philosophy", u: "https://plato.stanford.edu/entries/epistemology/", k: "website", d: "beginner", s: "The map of the whole field. Read this before any popular book on thinking." },
      ...
      { t: "The Gettier Problem", u: "https://iep.utm.edu/gettier/", k: "website", d: "beginner", s: "Three pages that broke a definition of knowledge that had stood for two thousand years." },
      ...
      { t: "Fallacies — IEP", u: "https://iep.utm.edu/fallacy/", k: "website", d: "beginner", s: "A proper taxonomy of bad arguments, with why each one fails rather than just its name." },
      ...
      { t: "Bayesian Epistemology — SEP", u: "https://plato.stanford.edu/entries/epistemology-bayesian/", k: "website", d: "intermediate", s: "Degrees of belief done formally, including the arguments against doing it this way." },
      { t: "The Problem of Induction", u: "https://plato.stanford.edu/entries/induction-problem/", k: "website", d: "intermediate", s: "Hume's problem, still unsolved, and underneath every empirical claim you will ever make." },
      { t: "Falsifiability and the demarcation problem", u: "https://plato.stanford.edu/entries/pseudo-science/", k: "website", d: "intermediate", s: "What separates science from what looks like it. Harder than Popper made it sound." },
      { t: "Scientific Objectivity — SEP", u: "https://plato.stanford.edu/entries/scientific-objectivity/", k: "website", d: "intermediate", s: "Whether the thing we trust science for is even the thing science has." },
      { t: "Testimony — SEP", u: "https://plato.stanford.edu/entries/testimony-episprob/", k: "website", d: "intermediate", s: "Almost everything you know, you were told. This is the epistemology of that." },
      ...
      { t: "Peer Disagreement — SEP", u: "https://plato.stanford.edu/entries/disagreement/", k: "website", d: "intermediate", s: "What you should do when someone as informed as you concludes the opposite." },
      { t: "Epistemic Justification — SEP", u: "https://plato.stanford.edu/entries/justep-foundational/", k: "website", d: "advanced", s: "Foundationalism against coherentism — the regress problem that starts the whole subject." },
      { t: "Formal Epistemology — SEP", u: "https://plato.stanford.edu/entries/formal-epistemology/", k: "website", d: "advanced", s: "Belief modelled mathematically, and where the models stop matching people." },
      ...
      { t: "Dutch Book Arguments — SEP", u: "https://plato.stanford.edu/entries/dutch-book/", k: "website", d: "advanced", s: "Why incoherent beliefs can be turned into a guaranteed loss, stated as a proof." },
      { t: "Social Epistemology — SEP", u: "https://plato.stanford.edu/entries/epistemology-social/", k: "website", d: "advanced", s: "Knowledge as something groups produce, which is how it is actually produced." },
      { t: "The Enduring Evolution of Logic", u: "https://plato.stanford.edu/entries/logic-classical/", k: "website", d: "advanced", s: "Classical logic stated precisely, for when informal reasoning stops being enough." },
      { t: "Reasoning and Argumentation — IEP", u: "https://iep.utm.edu/argument/", k: "website", d: "advanced", s: "Argument structure as a formal object: what makes one valid, sound, or merely persuasive." },
    ],
  },
];
